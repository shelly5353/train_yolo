...
export const ImageCanvas: React.FC<ImageCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    if (imageLoaded) {
      console.log('Image loaded, fitting to canvas...');
      handleResize();
    }
  ...
  // Convert image coordinates to canvas coordinates (unused but kept for future use)
  ...
  useEffect(() => {
    console.log('Draw useEffect triggered. imageLoaded:', imageLoaded, 'imageRef.current:', !!imageRef.current);
    const canvas = canvasRef.current;
    if (!canvas || !imageLoaded || !imageRef.current) {
      console.log('Canvas draw skipped - canvas:', !!canvas, 'imageLoaded:', imageLoaded, 'imageRef:', !!imageRef.current);
      return;
    }
    ...
    console.log('Image drawn to canvas. Size:', imageWidth, 'x', imageHeight, 'Transform:', transform);
    console.log('Transform details - x:', transform.x, 'y:', transform.y, 'scale:', transform.scale);
  ...
  useEffect(() => {
    ...
    if (canvas && container) {
      console.log('Updating canvas size to:', container.clientWidth, 'x', container.clientHeight);
